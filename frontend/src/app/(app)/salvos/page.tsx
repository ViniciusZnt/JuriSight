  ...
  return (
    <div className="min-h-full bg-[#F7F7F9]">
      <header className="pl-20 pr-8 py-4">
        <h1 className="text-[#0F1117]" style={{ fontSize: "20.7px", fontWeight: 600 }}>
          Salvos
        </h1>
      </header>
      ...
      <div className="flex flex-col items-center justify-center px-8 py-24 text-center">
        ...
        <h2 className="text-[#0F1117]" style={{ fontSize: "17.2px", fontWeight: 600 }}>
          Nenhuma decisão salva ainda
        </h2>
        <p className="mt-2 max-w-sm text-[#8A8A9A]" style={{ fontSize: "14.9px" }}>
