...
describe("provimentoToOutcome", () => {
  it("mapeia NEGADO para favorable", () => {
    expect(provimentoToOutcome("NEGADO")).toBe("favorable");
  });

  it("mapeia APROVADO para unfavorable", () => {
    expect(provimentoToOutcome("APROVADO")).toBe("unfavorable");
  });
